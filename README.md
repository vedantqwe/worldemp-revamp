...
API, with **no token and nothing exposed** (Chromium browsers only). Remotely,
at `<site>/admin/`, you sign in with GitHub — you can save exactly what your
GitHub account is allowed to push, and there's no second password anywhere.
