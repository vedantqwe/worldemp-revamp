  ...
  return (
    <section ref={ref} className="relative isolate overflow-hidden bg-we-indigo py-24 text-white sm:py-32">
      ...
      <div className="mx-auto max-w-5xl px-5 text-center sm:px-8">
        ...
        >
          Your next colleague is already out there.
        </motion.h2>
        <motion.p
        ...
        >
          Tell us the role. We will come back with a market analysis and a shortlist,
          and you pay nothing until someone starts.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 18 }}
          whileInView={{ opacity: 1, y: 0 }}
